...
def plot_validation_curve(train_scores, test_scores, train_sizes, expected_score=None, ax=None):
...
def plot_learning_curve(train_scores, test_scores, param_range, expected_score=None, ax=None):
...
def _plot_generic_curve(train_scores, test_scores, x_pars, expected_score=None, ax=None):
    train_score_mean, train_score_error, test_score_mean, test_score_error = \
        get_score_means_and_errors(train_scores, test_scores)
...
def get_score_means_and_errors(train_scores, test_scores):
